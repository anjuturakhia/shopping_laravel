...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<p>{{company}}</p>\n");
...
const routes = [
    ...
    { path: "company/:lang", canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_7__["AuthGuard"]], component: _company_company_component__WEBPACK_IMPORTED_MODULE_3__["CompanyComponent"] },
    { path: "login/:lang", component: _login_login_component__WEBPACK_IMPORTED_MODULE_5__["LoginComponent"] },
    { path: "contact/:lang", canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_7__["AuthGuard"]], component: _contact_contact_component__WEBPACK_IMPORTED_MODULE_4__["ContactComponent"] }
];
...
/* harmony import */ var _layout_topnav_topnav_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./layout/topnav/topnav.component */ "./src/app/layout/topnav/topnav.component.ts");
/* harmony import */ var _layout_sidenav_sidenav_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./layout/sidenav/sidenav.component */ "./src/app/layout/sidenav/sidenav.component.ts");
/* harmony import */ var _sidebar_directive__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./sidebar.directive */ "./src/app/sidebar.directive.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _layout_topnav_topnav_component__WEBPACK_IMPORTED_MODULE_6__["TopnavComponent"],
            _layout_sidenav_sidenav_component__WEBPACK_IMPORTED_MODULE_7__["SidenavComponent"],
            _sidebar_directive__WEBPACK_IMPORTED_MODULE_8__["SidebarDirective"],
        ...
        providers: [
            {
                ...
                useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["forwardRef"])(() => _app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"]),
                multi: true
            },
            _services_sidenav_service__WEBPACK_IMPORTED_MODULE_5__["SidenavService"], _auth_guard__WEBPACK_IMPORTED_MODULE_18__["AuthGuard"],
            _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_16__["JwtHelperService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_19__["AuthService"],
            { provide: _angular_common__WEBPACK_IMPORTED_MODULE_20__["APP_BASE_HREF"], useValue: window['_app_base'] || '/' },
            {
...
let AuthGuard = class AuthGuard {
    constructor(_authservice, _router, activatedRoute, translate) {
...
let CompanyComponent = class CompanyComponent {
    constructor(activatedRoute, router, translate, companyservice) {
        this.activatedRoute = activatedRoute;
        this.router = router;
        this.translate = translate;
    ...
    ngOnInit() {
        this.activatedRoute.params.subscribe((params) => {
            ...
            this.companyservice.getCompanylist(params['lang']).subscribe((data) => {
...
let ContactComponent = class ContactComponent {
    constructor(fb, router, activatedRoute, translate, contactservice) {
        this.fb = fb;
        this.router = router;
        this.activatedRoute = activatedRoute;
        this.translate = translate;
    ...
    onSubmit(modal) {
        if (this.f.valid) {
            ...
            this.contactservice.savecontact(this.f.value).subscribe((data) => {
                console.log(data);
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ngx-translate/core */ "./node_modules/@ngx-translate/core/fesm2015/ngx-translate-core.js");
/* harmony import */ var src_app_services_sharedservice_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/services/sharedservice.service */ "./src/app/services/sharedservice.service.ts");
/* harmony import */ var _services_sidenav_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../services/sidenav.service */ "./src/app/services/sidenav.service.ts");
...
let SidenavComponent = class SidenavComponent {
    constructor(sidenavserivce, sharedservice, activatedRoute, router, translate, cdr) {
...
SidenavComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./sidenav.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/layout/sidenav/sidenav.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./sidenav.component.css */ "./src/app/layout/sidenav/sidenav.component.css")).default]
    })
], SidenavComponent);
...
/* harmony import */ var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ngx-translate/core */ "./node_modules/@ngx-translate/core/fesm2015/ngx-translate-core.js");
/* harmony import */ var src_app_services_productlist_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/services/productlist.service */ "./src/app/services/productlist.service.ts");
...
let TopnavComponent = class TopnavComponent {
    constructor(sharedservice, translate, productservice, router, activatedRoute) {
        this.sharedservice = sharedservice;
        this.translate = translate;
...
TopnavComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-topnav',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./topnav.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/layout/topnav/topnav.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./topnav.component.css */ "./src/app/layout/topnav/topnav.component.css")).default]
    })
], TopnavComponent);
...
let LoginComponent = class LoginComponent {
    constructor(fb, loginservice, router, activatedRoute, translate) {
        this.fb = fb;
    ...
    onSubmit(modal) {
        if (this.f.valid) {
            console.log(this.f.value);
            this.loginservice.login(this.f.value).subscribe((data) => {
                console.log(data);
                //   this.products = data.home['products'];
                alert(data.message);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _services_productlist_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/productlist.service */ "./src/app/services/productlist.service.ts");
/* harmony import */ var _services_sharedservice_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../services/sharedservice.service */ "./src/app/services/sharedservice.service.ts");
...
let ProductComponent = class ProductComponent {
    constructor(productservice, mySharedService, activatedRoute, router, translate) {
        this.productservice = productservice;
    ...
    ngOnInit() {
        this.activatedRoute.params.subscribe((params) => {
            console.log(params['lang']);
            this.translate.use(params['lang']);
            this.productservice.getProducts(params['lang']).subscribe((data) => {
                // console.log(data.home['products']);
                this.products = data.home['products'];
...
let CompanyService = class CompanyService {
    constructor(http, token) {
        ...
        this.reqheadermain = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Authorization': 'Bearer ' + this.token.getToken() });
    }
...
module.exports = __webpack_require__(/*! C:\shopping\shopping_angular\shopping\src\main.ts */"./src/main.ts");
